...
export function RegulationToolsCard() {
  ...
  return (
    <div ref={cardRef} className="w-full max-w-5xl mx-auto bg-white dark:bg-[#252525] overflow-hidden border border-[#E2E8F0] dark:border-[#333333]">
      {/* Header */}
      <div className="relative bg-[#1a1a2e] dark:bg-[#1a1a2e] px-10 py-7">
      ...
      {isExpanded && (
        <>
          {/* Intro Section */}
          <div className="px-10 py-5 border-b border-[#E2E8F0] dark:border-[#333333] bg-[#FAFBFC] dark:bg-[#1A1A1A]">
            <p className="text-sm text-[#2D3748] dark:text-[#E5E5E5] leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="px-7 py-6 border-b border-[#E2E8F0] dark:border-[#333333] lg:border-r lg:border-b relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-1 before:h-full before:bg-[#2563EB]">
              <div className="mb-4">
                ...
                <p className="text-xs text-[#718096] dark:text-[#A0A0A0] italic">Activación del sistema parasimpático</p>
              </div>

              <div className="mb-3.5 last:mb-0">
                <h4 className="text-[10px] font-semibold uppercase tracking-wide text-[#718096] dark:text-[#A0A0A0] mb-2">Mecanismo</h4>
                <p className="text-xs text-[#2D3748] dark:text-[#E5E5E5] leading-relaxed">
                  La exhalación prolongada activa el nervio vago, funcionando como freno natural del sistema nervioso simpático.
                </p>
              </div>

              <div className="mb-3.5 last:mb-0">
                <h4 className="text-[10px] font-semibold uppercase tracking-wide text-[#718096] dark:text-[#A0A0A0] mb-2">Protocolo</h4>
                <ul className="space-y-1.5">
                  <li className="text-xs text-[#2D3748] dark:text-[#E5E5E5] pl-6 relative leading-normal">
              ...
              <div className="p-3 bg-[#EFF6FF] dark:bg-[#1A2A4A] rounded-md mt-3">
                ...
                <ul className="space-y-0.5">
                  <li className="text-[11px] pl-3.5 relative text-[#2D3748] dark:text-[#E5E5E5]">
            ...
            <div className="px-7 py-6 border-b border-[#E2E8F0] dark:border-[#333333] lg:border-b-0 relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-1 before:h-full before:bg-[#7C3AED]">
              <div className="mb-4">
                ...
                <p className="text-xs text-[#718096] dark:text-[#A0A0A0] italic">Estimulación bilateral y auto-contención</p>
              </div>
            ...
            <div className="px-7 py-6 border-b border-[#E2E8F0] dark:border-[#333333] lg:border-r lg:border-b-0 relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-1 before:h-full before:bg-[#0891B2]">
              <div className="mb-4">
                ...
                <p className="text-xs text-[#718096] dark:text-[#A0A0A0] italic">Anclaje sensorial al presente</p>
              </div>
            ...
            <div className="px-7 py-6 border-b-0 border-[#E2E8F0] dark:border-[#333333] relative before:content-[''] before:absolute before:top-0 before:left-0 before:w-1 before:h-full before:bg-[#B8860B]">
              <div className="mb-4">
                ...
                <p className="text-xs text-[#718096] dark:text-[#A0A0A0] italic">Activación de seguridad mediante tacto</p>
              </div>
              ...
              <div className="mb-3.5 last:mb-0">
                <h4 className="text-[10px] font-semibold uppercase tracking-wide text-[#718096] dark:text-[#A0A0A0] mb-2">Opciones</h4>
                <div className="grid grid-cols-2 gap-2 mt-2">
                  <div className="text-[11px] p-2.5 bg-[#F8FAFC] dark:bg-[#2A2A2A] rounded border border-[#E2E8F0] dark:border-[#333333]">
          ...
          {/* Practice Section */}
          <div className="px-10 py-5 bg-[#FAFBFC] dark:bg-[#1A1A1A] border-t border-[#E2E8F0] dark:border-[#333333]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-[600px] mx-auto">
              <div>
                <label className="text-xs font-medium text-[#2D3748] dark:text-[#E5E5E5] block mb-1.5">
                  La técnica que mejor me funciona:
                </label>
                <input
                  type="text"
                  className="w-full px-3 py-2.5 border border-[#E2E8F0] dark:border-[#333333] rounded bg-white dark:bg-[#252525] text-[13px] text-[#2D3748] dark:text-[#E5E5E5] placeholder:text-[#A0AEC0] dark:placeholder:text-[#666666]"
                  placeholder=""
                />
              </div>
              <div>
